@extends('base')
@section('conteudo')
@section('titulo', 'Formulário de loja')
@php
    if (!empty($dado->id)) {
...
<h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Formulario de Cliente</h2>
<dt class="font-medium text-red-700">Informe os dados para finaliar o seu cadastro!</dt>
